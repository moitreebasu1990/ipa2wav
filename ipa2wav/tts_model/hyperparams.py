...
class Hyperparams:
    ...
    n_iter_griffin = 60  # Number of Griffin-Lim iterations for waveform reconstruction
    ...
    K = 16  # Number of attention heads (for compatibility)
    attention_heads = 8  # Number of attention heads in multi-head attention
    attention_dim = 256  # Dimension of attention mechanism
    highway_layers = 2  # Number of highway network layers
